...
def speech_to_text():
    ...
    if oturum == False & isHey_Akbank(audio_path):
        oturum=True
    else:
        return jsonify({'error': 'Oturum daha başlatılmadı'})
    ...
    if speaker_prob < 0.01:  # Change this value to be more strict or lenient
